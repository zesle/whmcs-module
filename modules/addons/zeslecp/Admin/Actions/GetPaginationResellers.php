...
$totalUsers = Capsule::table('mod_zeslecp_users')->where("reseller", 1)->count();
...
if (!empty($_POST['page'])) {
    $pagConfig = array('baseURL' => '../modules/addons/zeslecp/Admin/Actions/GetPaginationResellers.php', 'totalRows' => $totalUsers, 'currentPage' => $page, 'perPage' => $limit, 'contentDiv' => '#usersTable');
} else {
    $pagConfig = array('baseURL' => '../modules/addons/zeslecp/Admin/Actions/GetPaginationResellers.php', 'totalRows' => $totalUsers, 'perPage' => $limit, 'contentDiv' => '#usersTable');
}
