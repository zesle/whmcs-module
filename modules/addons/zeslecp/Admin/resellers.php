...
$users = Capsule::table('mod_zeslecp_users')->where('reseller', 1)->limit($limit)->offset($page * $limit)->orderBy("updated_at", "DESC")->get();
?>
    ...
    <div class="tab-pane active" id="tab1">
        <div class="row" style="margin-bottom: 10px;">
            <div class="col-md-4 showEntries"  style="margin-top: 10px;">
                Show
                <select class="form-control select-inline" id="limit1" name="limit">
            ...
            <div class="col-md-8" style="text-align:right">
                <button id="addNewUser" class="btn btn-primary">
                    <i class="fas fa-plus"></i> &nbsp;Add a New Reseller
                </button>&nbsp;&nbsp;
                <button id="isResellers" class="btn btn-warning">
                    <i class="fas fa-sync"></i> &nbsp;Import & Synchronize Resellers
                </button>
            </div>
        </div>
        <div id="usersTable">
    ...
    <div class="modal-dialog" style="width:45%;">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Add a New Reseller</h2>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12" style="text-align: center;margin-top: 10px;">
                        <input id="createNewResellerBtn" class="btn btn-primary" type="button" value="Create User"/>
                    </div>
                </div>
                <div class="row">
...
<div class="modal" tabindex="-1" role="dialog" aria-hidden="true" id="editUserModal">
    <div class="modal-dialog" style="width:45%;">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">Edit a Reseller</h2>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -23px;">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group" style="margin-bottom: 6px;">
                                <div class="row">
                                    <div class="col-md-9">
                                        <input type="password" id="epassword" autocomplete="off" class="form-control input-400"/>
                                    </div>
                                    <div class="col-md-3">
                        ...
                        <div class="col-md-12">
                            <label>Re-type Password</label> 
                            <div class="form-group" style="margin-bottom: 6px;">
                                <input type="text" id="erpassword" autocomplete="off" class="form-control input-400"/>
                ...
                <div class="row">
                    <div class="col-md-12" style="text-align: center;margin-top: 10px;">
                        <input id="editResellerBtn" class="btn btn-primary" type="button" value="Edit User"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12" style="text-align: center;margin-top: 4px;">
